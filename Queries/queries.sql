...
-- Number of employees retiring put into new table
SELECT first_name, last_name
...
-- LEFT Join reitrement_info and dept_emp using aliases and a filter
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	de.to_date
...
-- Employee count by department number with order by added
SELECT COUNT(ce.emp_no), de.dept_no
FROM current_emp as ce
LEFT JOIN dept_emp as de
ON ce.emp_no = de.emp_no
